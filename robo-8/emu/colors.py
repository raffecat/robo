...
Tune = 23+6  # 23ns + 6ns adjust = 37°

# Y, ns (0-279), sat                  (1000/3.579545 ~= 279ns + 23ns = 302ns)
colors = [
    (0.0,  0,   0),     # black        180° + 37° + 0ns = 217°  (no color component)
    (1.0,  45,  0.68),  # magenta      180° + 37° + 45ns = 275°
    (0.68, 120, 0.68),  # red (+30)    180° + 37° + 120ns = 12°
    (0.68, 135, 0.68),  # orange       180° + 37° + 135ns = 31°
    (0.68, 180, 0.68),  # yellow       180° + 37° + 180ns = 89°
    (0.68, 225, 0.68),  # green        180° + 37° + 225ns = 147°
    (0.68, 270, 0.68),  # cyan         180° + 37° + 270ns = 205°
    (0.68, 300, 0.68),  # blue         180° + 37° + 300ns = 244°

    (0.47, 0,   0),     # grey         180° + 37° + 0ns = 217°  (no color component)
    (0.47, 45,  0.22),  # dark purple  180° + 37° + ? = 274° ??
    (0.47, 120, 0.22),  # dark red     180° + 37° +
...
print("adjust ",Tune,"is ang",(1.2886363636363 * Tune))
