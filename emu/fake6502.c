 ...
 *                                                   *
 *****************************************************
 * CHANGES for Robo Emulator                         *
 * - hookexternal removed                            *
 * - getvalue16 is dead code                         *
 * - added DEBUGGER                                  *
 *****************************************************/
...
#define DEBUGGER     //when this is defined, opcodes are disassembled and
                     //printed to stdout during execution for debugging.
